...
description: そんなに問題はなかったのですが、1つだけ大きな不具合に直面しました。キャンペーンでさらに2000ポイントもらえますのでぜひ。
layout: blog
category: Computer
...
- Rakuten UN-LIMITは容量追加が550円/1GBと安い部類。ただし翌月繰り越しはない。
- 通信品質は今のところ良好。  
...
![](/files/images/imports/2020/04/rm-1mbps.png)
...
![](/files/images/imports/2020/04/rm-1mbps.png "スーパーホーダイ テザリング時の通信状況グラフ")
