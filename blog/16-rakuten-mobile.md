...
|キャリア|プラン|縛り|月額|
|:--:|:--:|:--:|--:|
|docomo|ギガホ + かけ放題オプション|2年|**9,548円**|
|SoftBank|メリハリプラン + 通話定額オプション|-|**10,208円**|
|au|auデータMAXプラン Pro + 通話定額|2年|**10,098円**|
...
### MVNOとの比較
[楽天モバイル（MVNO）](https://mobile.rakuten.co.jp/fee/?l-id=header_pc_fee)【「スーパーホーダイ プランS」（**2GB**、10分まで通話無料）】は月額**3,278‬円**でした。  
同じ価格で、UN-LIMITは高速容量が5GBになりました。めちゃくちゃパワーアップしましたね。

他のMVNOの*（楽天MVNOを除いて）2020/4/14に*申し込み可能な【4Gの5GB付近プラン+通話定額オプション】の価格も比較していきましょう。  
...
ただ、Rakuten UN-LIMITはMVNOより以下の点で優れていると考えられます。

- 通話定額はOCNを除いて10分までしか選べませんが、UN-LIMITは無制限です。
- Rakuten UN-LIMITは容量追加が550円/1GBと安い部類です。ただし翌月繰り越しはありません。
